...
const sports = [
	...
	{ label: 'Basketball', value: 2, backgroundColor: '#fd9644', icon: 'basketball' },
	{ label: 'Soccer', value: 3, backgroundColor: '#fed330', icon: 'soccer' },
	{ label: 'Jump-Rope', value: 4, backgroundColor: '#26de81', icon: 'jump-rope' },
	{ label: 'Table-Tennis', value: 5, backgroundColor: '#2bcbba', icon: 'table-tennis' },
